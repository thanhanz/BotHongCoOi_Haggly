...
public static class InventoryEndpointExtensions
{
    ...
    private static async Task<IResult> GetInventoryAsync(Guid stallId, HttpContext context,
    ...
    private static async Task<IResult> AddItemAsync(Guid stallId, AddInventoryItemRequest request,
        HttpContext context, [FromServices] ISender sender, CancellationToken cancellationToken)
    {
    ...
    private static async Task<IResult> GetItemAsync(Guid stallId, Guid inventoryItemId,
        HttpContext context, [FromServices] ISender sender, CancellationToken cancellationToken)
    ...
    private static async Task<IResult> AdjustInventoryAsync(Guid stallId, AdjustInventoryRequest request,
        HttpContext context, [FromServices] ISender sender, CancellationToken cancellationToken)
        => Results.Ok(ApiResponse<InventoryItemDto>.Create(
    ...
    private static async Task<IResult> GetLedgerAsync(Guid stallId,
        [FromQuery] Guid? inventoryItemId, [FromQuery] InventoryTransactionType? transactionType,
        [FromQuery] int? page, [FromQuery] int? pageSize, HttpContext context,
        [FromServices] ISender sender, CancellationToken cancellationToken)
