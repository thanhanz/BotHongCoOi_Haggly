...
public sealed class MarketEndpointContractTests
{
    ...
    [Theory]
    [InlineData("/api/v1/markets/", 201, typeof(ApiResponse<MarketDto>))]
    [InlineData("/api/v1/markets/{id:guid}", 200, typeof(ApiResponse<MarketDto>))]
    [InlineData("/api/v1/markets/{id:guid}", 200, typeof(ApiResponse<bool>))]
